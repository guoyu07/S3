...
class Config {
    ...
    _getConfig() {
        ...
        this.websiteEndpointPrefix = 's3-website';
        if (config.websiteEndpointPrefix !== undefined) {
            assert(typeof config.websiteEndpointPrefix === 'string',
                'bad config: websiteEndpointPrefix must be a string');
            this.websiteEndpointPrefix = config.websiteEndpointPrefix;
        }
